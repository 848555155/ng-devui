...
describe('TreeSelect', () => {
  ...
  describe('single select', () => {
    ...
    it('should have correct styles', () => {
      const classes = ['.devui-tree-select', '.devui-tree-select-input', '.devui-select-chevron-icon'];

      expect(domHelper.judgeStyleClasses(classes)).toBeTruthy();
    });

    it('should open menu while click', fakeAsync(() => {
      const treeSelectEl: HTMLElement = debugEl.query(By.css('d-tree-select .devui-tree-select .devui-tree-select-input')).nativeElement;
      treeSelectEl.dispatchEvent(new Event('click'));
      fixture.detectChanges();
      tick(200);
      fixture.detectChanges();
      const classes = ['.devui-dropdown-origin-open'];
      expect(domHelper.judgeStyleClasses(classes)).toBeTruthy();
    }));
    ...
    it('should select node correctly', fakeAsync(() => {
      ...
      tick(200);
      fixture.detectChanges();
      const treeNodeEl: HTMLElement = debugEl.query(
        By.css('body .popper-container  d-operable-tree > div > d-tree > d-tree-nodes > div:nth-child(1) > div')
      ).nativeElement;
  ...
  describe('multiple select', () => {
    ...
    it('should check node work correctly', fakeAsync(() => {
      ...
      fixture.detectChanges();
      expect(
        debugEl.query(By.css('body .popper-container  d-operable-tree > div > d-tree > d-tree-nodes > div:nth-child(1)')).nativeElement
          .classList
      ).toContain('selected');
    }));
    ...
    it('should check node work correctly while setting leafOnly', fakeAsync(() => {
      ...
      tick(200);
      fixture.detectChanges();
      const treeNodeElParent: HTMLElement = debugEl.query(
        By.css('body .popper-container  d-operable-tree > div > d-tree > d-tree-nodes > div:nth-child(2) > div')
      ).nativeElement;
    ...
    it('should close menu when set isOpen to false', fakeAsync(() => {
      ...
      const classes = ['.devui-dropdown-origin-open', '.devui-dropdown-menu'];
      tick(200);
      expect(domHelper.judgeStyleClasses(classes)).not.toBeTruthy();
    }));
    ...
    it('should search correctly', fakeAsync(() => {
      ...
      tick(200);
      fixture.detectChanges();
      const searchInputEl = debugEl.query(
    ...
    it('should toggle node correctly', fakeAsync(() => {
      ...
      tick(200);
      fixture.detectChanges();
      const node = debugEl.query(
        By.css(`body d-operable-tree d-tree > d-tree-nodes > div:nth-child(2)
        > div.devui-tree-node__children > d-tree-nodes > div:nth-child(1) > div.devui-tree-node__content.devui-tree-node--parent
        > div > span.devui-tree-node__folder`)
      ).nativeElement;
